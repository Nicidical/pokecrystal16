...
CooltrainerMGroup:
	...
	db 35
	dw KINGLER
	dw WATER_PULSE, STOMP, GUILLOTINE, PROTECT
	db 35
	dw FLAREON
...
BugCatcherGroup:
	...
	db 25
	dw BEEDRILL
	dw FURY_ATTACK, FOCUS_ENERGY, X_SCISSOR, RAGE
	db 24
	dw BUTTERFREE
	...
	db 32
	dw BEEDRILL
	dw FURY_ATTACK, PURSUIT, X_SCISSOR, DOUBLE_TEAM
	db 34
	dw BUTTERFREE
...
FisherGroup:
	...
	db 25
	dw REMORAID
	dw LOCK_ON, PSYBEAM, AURORA_BEAM, WATER_PULSE
	db 25
	dw REMORAID
	dw LOCK_ON, PSYBEAM, AURORA_BEAM, WATER_PULSE
	db -1 ; end
	...
	db 38
	dw REMORAID
	dw PSYBEAM, AURORA_BEAM, WATER_PULSE, HYPER_BEAM
	db -1 ; end
...
SailorGroup:
	...
	db 20
	dw KRABBY
	dw WATER_PULSE, LEER, VICEGRIP, HARDEN
	db -1 ; end
